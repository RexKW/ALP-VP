...
fun HotelListView(
    ...
    cityName: String,
    journeyId: Int // Add journeyId parameter
) {
                ...
                when {
                    ...
                    errorMessage != null -> {
                        ...
                        LazyVerticalGrid(
                            ...
                            modifier = Modifier.fillMaxSize().padding(bottom = 100.dp), // Add padding for extra space at the bottom
                            ...
                            items(locations.filter {
                                ...
                                LocationCard(location = location) {
                                    ...
                                    navController.navigate("HotelDetail/${location.place_id}/$journeyId")
                                }
                            }
                        }
