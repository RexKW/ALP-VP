...
fun DestinationSearchView(
    ...
    val searchText = remember { mutableStateOf("") } // Search query state
            ...
            when (dataStatus) {
                ...
                DestinationDataStatusUIState.Start -> {
                    Box(
                        ...
                        Text("No destinations to display.", fontSize = 16.sp, color = Color.Gray)
                    }
                }
                else -> {
                    Box(
                        ...
                        Text("Unknown state. Please try again.", fontSize = 16.sp, color = Color.Gray)
                    }
                }
            }
        }
