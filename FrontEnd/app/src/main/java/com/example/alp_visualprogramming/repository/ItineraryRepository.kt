...
interface ItineraryRepository {
    ...
    fun getItinerary(token: String, id: Int): Call<GetItineraryResponse>
    fun updateItinerary(token: String, id: Int, title: String): Call<GeneralResponseModel>
    fun deleteItinerary(token: String, id: Int): Call<GeneralResponseModel>
...
class NetworkItineraryRepository(
    ...
    override fun createItinerary(token: String, title: String): Call<GetCreatedItineraryResponse> {
    ...
    override fun updateItinerary(token: String, id: Int, title: String): Call<GeneralResponseModel> {
        return itineraryAPIService.updateItinerary(token, id, ItineraryRequest(title))
    }

    override fun deleteItinerary(token: String, id: Int): Call<GeneralResponseModel> {
        return itineraryAPIService.deleteItinerary(token, id)
    }
}
