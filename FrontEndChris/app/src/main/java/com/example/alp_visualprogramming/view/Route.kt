...
//                composable("Activities/{dayId}/destinationName/{destinationName}") { backStackEntry ->
//                    val dayId = backStackEntry.arguments?.getString("dayId")?.toIntOrNull() ?: 0
...
//                        token = "e0f761c3-ab9c-44ee-9a9b-37719623c2e0",
//                        dayId = dayId,
//                        destinationName = destinationName, // Pass the destinationName
...
//                }
                ...
                composable("FormActivity") {
                    ActivityFormView(modifier = Modifier.padding(innerPadding), navController = navController, activityFormViewModel = activityFormViewModel, context = localContext, token = "e0f761c3-ab9c-44ee-9a9b-37719623c2e0",
                        )
                }
            }
